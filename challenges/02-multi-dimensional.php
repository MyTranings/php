...
<head>
  ...
  <title>PHP From Scrach - Multi-dimesional Challenge</title>
</head>

<body>
  <h2>Multi-dimensional Challenges</h2>

  <h3>Challenge 1: Loop</h3>
    ...
    <div class="md my-4">
      <div class="bg-white rounded-lg shadow-md">
        <div class="p-4">
          ...
          <p class="text-gray-700 text-lg mt-2">We are seeking a skilled software engineer to develop high-quality
    ...
    <div class="md my-4">
      <div class="bg-white rounded-lg shadow-md">
        <div class="p-4">
          ...
          <p class="text-gray-700 text-lg mt-2">We are looking for a marketing specialist to develop and implement
